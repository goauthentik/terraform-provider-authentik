...
- `meta_app` (String) Static value of `authentik_stages_authenticator_webauthn` Generated.
- `meta_model` (String) Static value of `authenticatorwebauthnstage` Generated.
